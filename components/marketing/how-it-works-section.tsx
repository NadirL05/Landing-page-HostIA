...
const STEPS = [
  ...
  { time: "8 s", title: "Réservation prise et reformulée", body: "L'agent confirme date, heure, nombre de couverts et coordonnées, puis reformule pour éviter toute erreur." },
