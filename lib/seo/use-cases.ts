...
export const USE_CASES: readonly UseCaseMeta[] = [
  {
    ...
    ctaSecondaryLabel: "Essayer HostIA",
    ctaSecondaryHref: SIGNUP_URL,
    ctaFinalHeading: "Une réservation de moins à gérer pendant le service",
    ctaFinalBody: "Testez le scénario de réservation sur la démo publique, sans inscription, ou passez directement à l'essai.",
  ...
  },
  {
    ...
    ctaFinalBody: "Testez le scénario de commande sur la démo publique, sans inscription, ou passez directement à l'essai.",
